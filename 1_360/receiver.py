...
class Receiver:
    def __init__(self):
        self.url = "https://chat.360.com/chat/496698f8fa811273"
    ...
    def fetch_messages(self, page):
        """获取用户发送的消息"""
        send_messages = page.query_selector_all('div.msg-item.msg-item-mine section div p')
        messages = []
        ...
        while self.running:
            with sync_playwright() as p:
                ...
                try:
                    page.goto(self.url)
                    time.sleep(5)
                    page.wait_for_selector('div.msg-item', timeout=10000)
